...
public:
    ...
    /// Create a new button element and return its pointer.
    /// A function must be provided to call when the button is clicked.
    Button* CreateButton( void(*callback)() );
...
private:
    ...
    void UpdateButtonElements(void);
    ...
    PoolAllocator<Button> mButtonElements;
